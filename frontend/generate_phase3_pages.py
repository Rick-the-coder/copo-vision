...
pages = {
    "CourseOutcomes": {
        "endpoint": "course-outcomes",
        "interface": "CourseOutcome",
        "fields": [
            {"name": "course_id", "label": "Course ID", "type": "number"},
            {"name": "co_number", "label": "CO Number", "type": "text"},
            {"name": "co_title", "label": "Title", "type": "text"},
            {"name": "co_description", "label": "Description", "type": "text"},
...
for page_name, config in pages.items():
    ...
    for f in fields:
        ...
        required = "" if ("description" in f['name'] or "co_id" in f['name']) else "required: true"
