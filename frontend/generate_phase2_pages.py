...
pages = {
    "Programs": {
        ...
        "interface": "Program",
        "fields": [
            {"name": "program_code", "label": "Code", "type": "text"},
            {"name": "program_name", "label": "Name", "type": "text"},
    ...
    "Batches": {
        ...
        "interface": "Batch",
        "fields": [
            {"name": "batch_name", "label": "Name", "type": "text"},
            {"name": "batch_year", "label": "Year", "type": "number"},
    ...
    "Sections": {
        ...
        "interface": "Section",
        "fields": [
            {"name": "section_name", "label": "Name", "type": "text"},
            {"name": "batch_id", "label": "Batch ID", "type": "number"},
            {"name": "semester_id", "label": "Semester ID", "type": "number"},
            {"name": "mentor_faculty_id", "label": "Mentor ID", "type": "number"}
        ]
    },
    "CourseOfferings": {
...
for page_name, config in pages.items():
    ...
    for f in fields:
        ...
        required = "" if "id" in f['name'] and "department" not in f['name'] else "required: true"
